		...
		<body>
			...
			<br />
				<table cellspacing="0" cellpadding="5" border="0">
					<tr>
						<td>
							<h>@@inform_you_item_below@@</h><br /><br />
							<h>@@borrowed_by_you@@</h><br /><br />
							<h>@@decalred_as_lost@@</h><br /><br />
							<h>@@additional_info_1@@</h><br />
						</td>
					</tr>
				</table>
										...
										<tr>
												...
												<table>
													<tr>
														<td style="text-align: center;padding:0px;">
															...
															<span style="visibility: hidden;mso-hide:all" class="itembarcode">*<xsl:value-of select="item_loan/barcode"/>*</span>
															<span class="itembarcodenumbers"><xsl:value-of select="item_loan/barcode"/></span>
														</td>
													</tr>
												</table>
											</td>
											...
											<td>
												<xsl:for-each select="fines_fees_list/user_fines_fees">
													<xsl:value-of select="fine_fee_ammount/sum"/>&#160;<xsl:value-of select="fine_fee_ammount/currency"/>&#160;<xsl:value-of select="ff"/>
												</xsl:for-each>
											</td>
										</tr>
									</xsl:for-each>
