        ...
        <div class="messageArea">
          <div class="messageBody">
            <table cellspacing="0" cellpadding="5" border="0">
              <!--tr>
                <td><b>@@print_date@@: </b>
                <xsl:value-of select="notification_data/request/create_date" />-<xsl:value-of select="notification_data/request/create_time" /></td>
              </tr-->
              <tr>
                <td>
                  <b>@@request_id@@: </b>
              ...
              <xsl:if test="notification_data/user_for_printing/note">
                <tr>
                  <td>
                    <b>@@user_note@@: </b><xsl:value-of select="notification_data/user_for_printing/note" />
                  </td>
                </tr>
              </xsl:if>
              ...
              <xsl:if test="notification_data/user_for_printing/name">
                <tr>
                  <td>
                    <b>@@requested_for@@: </b><xsl:value-of select="notification_data/user_for_printing/name" />
                  </td>
                </tr>
				<tr>
					<td>
			  ...
			  <xsl:if test="notification_data/phys_item_display/owning_library_name">
				...
				<tr>
					<td><h2><b>@@to@@: </b>
					<xsl:value-of select="notification_data/request/calculated_destination_name" /></h2></td>
				</tr>
            </table>
          </div>
        </div>
        <!-- recordTitle.xsl -->
        <xsl:call-template name="lastFooterKvitto" />
        <!-- footer.xsl -->
      </body>
    </html>
  </xsl:template>
