	...
	<html>
		...
		<xsl:call-template name="generalStyle" />
			...
			<xsl:attribute name="style">
				...
				<h>@@following_loaned_item_which_has@@. @@your_account_balance_will_be_credited@@. @@bellow_details_charges_credits_due@@</h>
				...
				<table>
					<tr>
						<td>
						<b>@@title@@: </b> <xsl:value-of select="item_loan/title"/>
						<br />
