	...
	<html>
		...
		<div class="messageArea">
				<div class="messageBody">
						...
						<tr>
							<td>@@on@@ <xsl:value-of select="notification_data/general_data/current_date"/> @@we_cancel_y_req_of@@ <xsl:value-of select="notification_data/request/create_date"/>:</td></tr>
						<tr>
