					...
					<div class="messageBody">
						<xsl:if test="notification_data/user_for_printing/name">
							<table cellspacing="0" cellpadding="5" border="0" style="width:100%;">
								<tr>
									<td style="width:80px; vertical-align: top; padding: 0px;">
									...
									<td style="vertical-align: top; padding: 0px; padding-bottom: 10px">
										...
										<div>
											<xsl:choose>
												<xsl:when test="contains(notification_data/phys_item_display/available_items/available_item/item_policy, 'reading_room')">
													<span style="font-size: 20px">
														Reading room loan
													</span>
												</xsl:when>
												<xsl:when test="contains(notification_data/phys_item_display/location_code, 'OUT_RS_REQ')">
													<span style="font-size: 20px">
										...
										<!-- 20190424 Bortkommenterat Låntagarens namn för att göra anonyma slippar -->
										...
										<!-- 20190424 Lagt till additional ID för att göra anonyma slippar -->
